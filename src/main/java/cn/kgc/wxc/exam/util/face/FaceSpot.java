...
public class FaceSpot {
    ...
    //需要修改为自己的
    private static final String AppID = "22066937";
    private static final String APIKey = "hsKI4D0bf6U75bMyjeXRiBvF";
    private static final String SecretKey = "HMtPhGM064UyW9B4pIezsHRURAaItydh";
    ...
    public static void main(String[] args) throws IOException {
        ...
        String file1 = "Z:\\study\\Face\\a6.jpg";
        byte[] img2 = FileToByte(new File(file1));
        System.out.println(searchFace(img2,"face","1"));
        JSONObject json = new JSONObject(searchFace(img2,"face","1"));
